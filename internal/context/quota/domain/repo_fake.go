...
// Source: internal/context/quota/domain/repo.go
...
func (m *FakeRepo) Get(ctx context.Context, id string) (*Quota, error) {
	m.ctrl.T.Helper()
...
func (m *FakeRepo) Save(ctx context.Context, quota *Quota) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Save", ctx, quota)
	ret0, _ := ret[0].(error)
	return ret0
}

// Save indicates an expected call of Save.
func (mr *FakeRepoMockRecorder) Save(ctx, quota interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Save", reflect.TypeOf((*FakeRepo)(nil).Save), ctx, quota)
}
