...
// Source: internal/context/extrapriority/domain/repo.go
...
func (m *FakeRepo) Get(ctx context.Context, id string) (*ExtraPriority, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", ctx, id)
	ret0, _ := ret[0].(*ExtraPriority)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *FakeRepo) Save(ctx context.Context, priority *ExtraPriority) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Save", ctx, priority)
	ret0, _ := ret[0].(error)
	return ret0
}

// Save indicates an expected call of Save.
func (mr *FakeRepoMockRecorder) Save(ctx, priority interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Save", reflect.TypeOf((*FakeRepo)(nil).Save), ctx, priority)
}
