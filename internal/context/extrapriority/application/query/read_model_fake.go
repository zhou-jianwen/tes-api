...
// Source: internal/context/extrapriority/application/query/read_model.go
...
func (m *FakeReadModel) List(ctx context.Context, filter *ListFilter) ([]*ExtraPriority, error) {
	m.ctrl.T.Helper()
